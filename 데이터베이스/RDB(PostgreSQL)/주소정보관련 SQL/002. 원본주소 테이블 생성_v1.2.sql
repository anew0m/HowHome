...
CREATE TABLE ROWDATA_ADDR.TBL_RNA_BLD ( -- 도로명주소_건물 테이블		
	...
	ADR_LTN_ORN_NMB NUMERIC  ,  -- 주소_지번_본번_번호 - 번호_INT		
	ADR_LTN_VCN_NMB NUMERIC  ,  -- 주소_지번_부번_번호 - 번호_INT		
	...
	ADR_BLD_ORN_NMB NUMERIC  ,  -- 주소_건물_본번_번호 - 번호_INT		
	ADR_BLD_VCN_NMB NUMERIC  ,  -- 주소_건물_부번_번호 - 번호_INT		
...
CREATE TABLE ROWDATA_ADDR.TBL_RNA_BLD_RLT_LTN ( -- 도로명주소_건물_관련_지번 테이블		
	...
	ADR_BLD_ORN_NMB NUMERIC NOT NULL ,  -- 주소_건물_본번_번호 - 번호_INT		
	ADR_BLD_VCN_NMB NUMERIC NOT NULL ,  -- 주소_건물_부번_번호 - 번호_INT		
...
CREATE TABLE ROWDATA_ADDR.TBL_RNA_NVG_BLD ( -- 도로명주소_내비게이션_건물 테이블		
	...
	ADR_ADD_ACD VARCHAR(14)  ,  -- 주소_행정동_주소코드 - 주소코드_VAR14		
	ADR_ADD_NM VARCHAR(200)  ,  -- 주소_행정동_명칭 - 명칭_VAR200		
	ADR_GRD_FLR_NMR NUMERIC  ,  -- 주소_지상_층_개수 - 개수_INT		
	ADR_UND_FLR_NMR NUMERIC  ,  -- 주소_지하_층_개수 - 개수_INT		
	ADR_APT_CCD VARCHAR(2)  ,  -- 주소_공동주택_구분코드 - 구분코드_VAR2		
	ADR_SMN_ADR_BLD_NMR NUMERIC  ,  -- 주소_동일_주소_건물_개수 - 개수_INT		
	ADR_DTL_BLD_NM VARCHAR(200)  ,  -- 주소_상세_건물_명칭 - 명칭_VAR200		
